 ...
 * which is exactly what a karaoke track is for. Only search-based providers (QQ, NetEase) may
 * rewrite: exact-ID lookups always use the playing title verbatim, and rewritten searches are
 * marked as substituted matches in the catalog.
 */
public final class KaraokeTitles {
    ...
    public static SpotifyTrack forLyricsSearch(SpotifyTrack track, boolean originalLyrics) {

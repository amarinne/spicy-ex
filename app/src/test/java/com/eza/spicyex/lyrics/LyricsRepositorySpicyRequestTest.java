...
public class LyricsRepositorySpicyRequestTest {
    ...
    private static final String UPSTREAM_VERSION = "6.3.10";
    private static final String UPSTREAM_BODY = "{\"queries\":[{\"operation\":\"lyrics\",\"variables\":{\"id\":\"4uLU6hMCjMI75M1A2tKUQC\",\"auth\":\"SpicyLyrics-WebAuth\"}}],\"client\":{\"version\":\"6.3.10\"}}";
    private static final String UPSTREAM_BODY_HEX = "";

    @Test
    public void lyricsQueryBodyMatchesUpstream6310JsonStringifyBytes() {
    ...
    public void jsonStringEscapingMatchesUpstreamForUtf8AndLoneSurrogate() {
        ...
        assertEquals("", hex(body));
        assertEquals(137, body.length);
    }

    @Test
    public void lyricsRequestUsesExactUpstream6310PayloadAndHeaders() throws Exception {
